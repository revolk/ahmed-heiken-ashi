...
export default function App() {
  // التوكن هنا بيوصل عادةً من رابط شخصي أو شاشة دخول بسيطة؛ بنقرأه من الرابط كمثال مباشر
  ...
  const [candles] = useState([]); // هتتغذى من API التاريخي لاحقًا
  ...
  return (
    <div className="app-shell">
      <header className="app-header">
        <h1 className="app-title">Ahmed Heiken Ashi</h1>
